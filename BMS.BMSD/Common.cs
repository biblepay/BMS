...
namespace BiblePay.BMSD
{
    public static class Common
    {
        ...
        {
            bool fUnix = RuntimeInformation.IsOSPlatform(OSPlatform.Linux) || Environment.OSVersion.Platform == PlatformID.Unix;
            return !fUnix;
        }
        ...
        public static void Log(string sData)
        {
            ...
            { 
				System.IO.StreamWriter sw = new System.IO.StreamWriter("bms_catastrophic.log", true);
				string Timestamp = DateTime.Now.ToString();
				sw.WriteLine(Timestamp + ": " + sData);
				sw.Close();
