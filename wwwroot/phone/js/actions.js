...
const myPhoneNumberDisplay = document.querySelector('.clsPhoneDisplay');
...
const callStateConnected = (video) => {
  ...
  callTransferButton.onclick = createTransferCall;
    myPhoneOutput.innerHTML = 'Connected';
...
const callStateDisconnected = () =>
{
  ...
  myPhoneOutput.innerHTML = ''; // call state narr
  myPhoneNumberDisplay.innerHTML = ''; // clear outgoing phone number
