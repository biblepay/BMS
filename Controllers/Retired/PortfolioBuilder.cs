...
namespace BiblePay.BMS.Controllers
{
	public class PortfolioBuilderController : Controller
    {
        ...
        public IActionResult PortfolioBuilder()
        {
            ...
            ddSymbol.Add(new DropDownItem{ key0 = "BTC", text0 = "Bitcoin" });
            ddSymbol.Add(new DropDownItem{ key0 = "DOGE", text0 = "DOGE" });
            ddSymbol.Add(new DropDownItem{ key0 = "DASH", text0 = "DASH" });
