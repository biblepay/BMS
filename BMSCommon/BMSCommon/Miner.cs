...
namespace BMSCommon
{
    public static class CryptoUtils
    {
        ...
        public class Block
        {
            ...
            public static void CheckDatabase()
            {
                ...
                if (!fDBExists)
                {
                    ...
                    bool fSuccess = Database.ExecuteNonQuery(cmd1);
                    if (!fSuccess)
                    {
            ...
            bool fSuccess0 = Database.ExecuteNonQuery(cmd0);
            ...
            fSuccess0 = Database.ExecuteNonQuery(cmd0);
        ...
        public static User RowToUser(DataRow dr)
        {
            ...
            if (u.BioURL=="" || u.BioURL == null)
                 u.BioURL = "/img/demo/avatars/emptyavatar.png";
