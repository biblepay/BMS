...
namespace BMSCommon
{
    public static class PortfolioBuilder
    {
        ...
        public struct PortfolioParticipant
        {
            ...
            public double RXRewards;
            public double BonusMagnitude;
        ...
        public static DataTable GetActivePortfolioBuilderUsers(bool fTestNet)
        {
            ...
            string sql = "Select NickName,ERC20Address," + sPBField + " as pbaddress," + sPBSigField + " as pbsig from " 
                + sUserTable + " where " + sPBField + " is not null and ERC20Address is not null and LENGTH(ERC20Address) > 20;";
            MySqlCommand q = new MySqlCommand(sql);
            DataTable dt1 = BMSCommon.Database.GetDataTable2(q);
            return dt1;
        }
