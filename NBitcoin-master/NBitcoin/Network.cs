...
namespace NBitcoin
{
	...
	public partial class Network
	{
...
#endif
			base58Prefixes[(int)Base58Type.PUBKEY_ADDRESS] = new byte[] { (25) };
			base58Prefixes[(int)Base58Type.SCRIPT_ADDRESS] = new byte[] { (16) }; //5
			base58Prefixes[(int)Base58Type.SECRET_KEY] = new byte[] { (182) }; //128
		...
		private void InitTest()
		{
			...
			base58Prefixes[(int)Base58Type.PUBKEY_ADDRESS] = new byte[] { (140) };
			base58Prefixes[(int)Base58Type.SCRIPT_ADDRESS] = new byte[] { (19) };
